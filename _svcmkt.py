...
INTRO = [
    ("단순한 상위노출이 아닌, 콘텐츠 마케팅입니다",
     ...
     "콘텐츠로 인천 기업·매장의 설득력을 만듭니다. 검색광고를 대체하는 효과를 클릭당 비용 없이 얻을 수 있습니다."),
    ("전담 팀이 만들고, 숫자로 보고합니다",
     "1:1 전담 디자이너와 작가가 배정되어 원고·카드뉴스·영상 소재를 직접 만들고, 포스팅 URL·노출 순위·"
     "인사이트를 정리한 결과보고 시스템으로 성과를 투명하게 공유합니다. 인천·부천·시흥 등 서부수도권은 "
     "촬영과 대면 미팅까지 바로 잡을 수 있어, 소재 제작부터 보고까지 더 밀착해서 움직입니다."),
]

# 세부 서비스 7종 (제목, 이미지, 설명, 칩4) — 본사 상품 라인업 순서 그대로
# ⚠️블록 이미지 = _mktvisuals.py가 굽는 vis-*.jpg (본사 배너 크롭 mkt-*.jpg는 톤 불일치·제목 중복으로 폐기)
BLOCKS = [
    ("브랜드 블로그", M + "vis-blog.jpg",
     "단순한 글쓰기가 아닙니다. 브랜드의 방향성과 톤앤매너를 담아, 홈페이지를 대신할 수 있는 공식 블로그를 전반적으로 운영·관리합니다. 인천 상권·업종 키워드를 분석해 인지도를 높이는 저비용 고효율의 운영대행 서비스입니다.",
     ["전담 디자이너 · 작가 배정", "키워드 원고 월 10건 발행", "카드뉴스 · 이미지 월 60개", "포스팅 · 노출순위 결과보고"]),
    ("브랜드 인스타그램", M + "vis-insta.jpg",
     "비주얼 중심의 인스타그램은 브랜드 아이덴티티를 시각적으로 전달하고, 브랜드 가치를 효과적으로 확장하는 데 최적의 채널입니다. 인천 매장·브랜드의 감도·분위기·메시지를 피드 하나하나에 담아 운영합니다.",
     ["피드 포스팅 월 10건", "카드뉴스 월 20건 이상", "소통 · 품앗이 · DM 작업", "인사이트 결과보고"]),
    ("네이버 준·최적배포", M + "vis-baepo.jpg",
     "광고는 넘기고, 콘텐츠엔 멈춥니다. 경쟁도가 강한 키워드는 최적화 기자단, 약한 키워드는 준최 기자단으로 — 광고가 아닌 콘텐츠로 상위노출되어 브랜드 신뢰를 높이고, 인천 지역 키워드까지 폭넓게 동시 노출합니다.",
     ["최적화 기자단 배포", "준최 기자단 배포", "다수 키워드 동시 노출", "인천 지역 키워드 커버"]),
    ("인스타그램 상위노출", M + "vis-top.jpg",
     "이제는 검색도 인스타그램에서 시작됩니다. 인천 맛집·뷰티·서비스를 찾는 고객의 해시태그 검색에서 브랜드의 비주얼 콘텐츠를 추천 탭 상단에 노출시켜, 첫인상과 선택의 기준을 만들어 드립니다.",
     ["해시태그 추천탭 상단 노출", "리그램 · 포스팅 상위노출", "키워드별 노출 방법 선정", "계정 최적화 작업"]),
    ("퍼포먼스 마케팅", M + "vis-perf.jpg",
     "네이버·구글 검색광고(SA)부터 정교한 타겟팅의 메타 광고(DA)까지, 마케팅 목표에 가장 적합한 매체와 소재를 전략적으로 분석합니다. 인천·수도권 지역 타겟팅으로 예산 낭비 없이 성과를 극대화합니다.",
     ["네이버 · 구글 검색광고", "메타 광고 운영", "지역 타겟팅 설계", "성과 분석 리포트"]),
    ("숏폼 콘텐츠", M + "vis-short.jpg",
     "브랜드를 기억시키는 가장 빠른 방법, 숏폼. 스튜디오·PD·기획자·마케터가 한 팀으로 기획부터 촬영·편집·알고리즘 확산까지 운영합니다. 인천·부천·시흥 매장은 현장 출장 촬영도 빠르게 잡아 드립니다.",
     ["기획 · 촬영 · 편집 원스톱", "릴스 · 쇼츠 제작", "인천 현장 출장 촬영", "알고리즘 확산 운영"]),
    ("언론홍보", M + "vis-press.jpg",
     "브랜드 런칭, 신제품 출시 등 인천 기업의 PR 이슈를 주요 포털 뉴스 탭에 노출하는 마케팅입니다. 마케터와 전문 작가가 핵심 키워드를 전략적으로 배치한 보도자료를 제작해 신속하고 정확하게 송출합니다.",
